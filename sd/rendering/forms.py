...
class EditForm(grok.EditForm):
    ...
    template = grok.PageTemplate(filename="templates/form.pt")
    ...
    @grok.action(__(u"label_save", default="Save"),
    ...
    def handle_save_action(self, **data):
        ...
        self.request.response.redirect(self.context.context.absolute_url())

    @grok.action(__(u"label_cancel", default=u"Cancel"),
